...
gobernanza.py
=============
CAPA 1 · GOBERNANZA DEL DATO — prevenir que el veneno entre al pipeline.
...
if __name__ == "__main__":
    ...
    from ataque_poisoning import _fabricar_registros_falsos
    import numpy as np
    rng = np.random.default_rng(0)
    falso = _fabricar_registros_falsos(1, rng).iloc[0].to_dict()
